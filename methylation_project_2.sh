...
#This script deals with the files 741, 742, 743, and 744.
...
# #Download Dataset
prefetch -O ${OUT} SRR333741 SRR333742 SRR333743 SRR333744

for i in SRR333737 SRR333741 SRR333742 SRR333743 SRR333744
do
  fastq-dump --split-files ${OUT}/${i} -O ${OUT}
done

# #data trimming
for i in SRR333741 SRR333742 SRR333743 SRR333744
do
